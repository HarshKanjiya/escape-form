...
import { BarChart2, Clock, Diamond, Gem, ImagePlus, Menu, MonitorSmartphone, Settings, Settings2, Shield, SidebarIcon, Users2, X, ChevronDown, Replace, Delete, Trash2 } from 'lucide-react';
