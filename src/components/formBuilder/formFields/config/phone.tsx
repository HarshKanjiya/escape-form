...
export function PhoneFieldConfig() {
    ...
    const [international, setInternational] = useState(selectedQuestion?.validation?.international || false);
    ...
    useEffect(() => {
        if (international != selectedQuestion?.validation?.international) updateQuestion(selectedQuestion?.id || '', { validation: { international } });
    }, [international]);
    ...
    return (
        <div className="flex flex-col overflow-y-clip">
            ...
            <div className="flex items-center justify-between">
                <Label htmlFor="phone-international">International</Label>
